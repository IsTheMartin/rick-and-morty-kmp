...
class RickAndMortyApiFake : RickAndMortyApi {
    ...
    override suspend fun getCharacters(page: Int): Result<CharacterResponse> =
        charactersResult ?: Result.failure(Exception("Not initialized"))

    override suspend fun getCharacter(id: Int): Result<CharacterResponse.CharacterData> =
        characterResult ?: Result.failure(Exception("Not initialized"))

    override suspend fun getLocations(page: Int): Result<LocationResponse> = locationsResult ?: Result.failure(Exception("Not initialized"))

    override suspend fun getEpisodes(page: Int): Result<EpisodeResponse> = episodesResult ?: Result.failure(Exception("Not initialized"))
}
